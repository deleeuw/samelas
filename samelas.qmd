...
images. Guttman's approach was built out to a system of non-metric scaling methods by James C. Lingoes, Edward E. C. H. Roskam, and Ingwer Borg. See the collection @lingoes_roskam_borg_79.

lmost simultaneously with the seminal contributions of Shepard/Kruskal and Guttman/Lingoes/Roskam, there was *Elastic Scaling* proposed by Victor E. McGee in a series of papers (@mcgee_65, @mcgee_66, @mcgee_67, @mcgee_68) and *Sammon Mapping*, proposed by John W. Sammon Jr. (@sammon_69).

The Elastic method has been largely forgotten, but it is worth preserving, because it is different in some important aspects from the more well-known methods. In engineering and computer science Sammon Mapping is still a popular dimension reduction method. It was originally intended to map points from a higher-dimensional Euclidean space into points in a lower-dimensional Euclidean space by approximating the known higher dimensional distances by best-fitting lower dimensional ones. 
